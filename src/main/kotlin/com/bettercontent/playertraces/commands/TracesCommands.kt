package com.bettercontent.playertraces.commands
            ...
            Commands.literal("playertraces")
                ...
                .then(
                    Commands.literal("dev")
                        .requires { it.hasPermission(2) || com.bettercontent.playertraces.config.TracesConfig.common.devVisualFixture.get() || java.lang.Boolean.getBoolean("traces.visualValidation") }
                        .then(
