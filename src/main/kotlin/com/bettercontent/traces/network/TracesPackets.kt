    ...
    companion object {
        fun decode(buf: FriendlyByteBuf): TraceQueryResponsePacket {
            ...
            repeat(traceCount) {
                ...
                require(movementOrdinal in com.bettercontent.traces.domain.MovementClass.values().indices) {
                ...
                traces += VisibleTraceDto(
                    id,
                    sequenceId,
                    com.bettercontent.traces.domain.MovementClass.values()[movementOrdinal],
                    x,
                    y,
                    z,
                    facingYaw,
