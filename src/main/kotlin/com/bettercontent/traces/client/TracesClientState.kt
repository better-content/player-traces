...
object TracesClientState {
    ...
    fun acceptAnnotationEcho(packet: com.bettercontent.traces.network.AnnotationEchoResponsePacket) {
        ...
        val clip = runCatching { com.bettercontent.traces.logic.AnnotationEchoValidation.decode(encoded) }
