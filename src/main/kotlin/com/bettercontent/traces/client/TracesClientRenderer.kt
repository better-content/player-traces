...
object TracesClientRenderer {
    ...
    fun onRenderLevelStage(event: RenderLevelStageEvent) {
        ...
        try {
            ...
            com.bettercontent.traces.domain.AnnotationComponents.icons.forEach { buffer.endBatch(TracesRenderTypes.note(it)) }
    ...
    private fun emitBloodPool(
        ...
        pool: com.bettercontent.traces.dto.VisibleBloodPoolDto,
    ) {
    ...
    private fun buildGuidanceSegments(
        level: net.minecraft.world.level.Level,
        routes: List<com.bettercontent.traces.dto.GuidanceRouteDto>,
        playerPosition: Vec3,
